...
See the [Feature flags](docs/features.md) for more information.
...
After a while, open the [http://localhost:8080](http://localhost:8080) address in your browser, and provide your kubeconfig in the Add Cluster wizard.
