...
import { Button, FlexBox, MessageBox, Text } from '@ui5/webcomponents-react';
import {
...
import { fetchResourcesToApply } from '../communityModulesHelpers';
import { uploadResource } from '../communityModulesInstallHelpers';
