...
export const List = lazyWithRetries(() => import('./RoleList'));
export const Details = lazyWithRetries(() => import('./RoleDetails'));
export const Create = lazyWithRetries(() => import('./RoleCreate'));
