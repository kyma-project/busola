...
export const List = lazyWithRetries(() => import('./StorageClassList'));
export const Details = lazyWithRetries(() => import('./StorageClassDetails'));
export const Create = lazyWithRetries(() => import('./StorageClassCreate'));
