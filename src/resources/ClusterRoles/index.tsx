...
export const List = lazyWithRetries(() => import('./ClusterRoleList'));
export const Details = lazyWithRetries(() => import('./ClusterRoleDetails'));
export const Create = lazyWithRetries(() => import('./ClusterRoleCreate'));
