...
export const List = lazyWithRetries(() => import('./SecretList'));
export const Details = lazyWithRetries(() => import('./SecretDetails'));
export const Create = lazyWithRetries(() => import('./SecretCreate'));
