...
| **description**       | No       | string or [JSONata](100-jsonata.md) expression | Used to fetch additional information that will be displayed in a popover after clicking on the badge.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **descriptionLink**   | No       | string or [JSONata](100-jsonata.md) expression | A URL displayed as a clickable link inside the badge popover. Can be combined with **description** to show both text and a link.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
- source: status.value
  ...
  descriptionLink: status.documentationUrl
```
...
The `TimeFromNow` widget calculates the time difference between the date provided in **source** and the current time and displays it in the format X days/hours/minutes/seconds ago.
