...
| **description** | No       | string, [JSONata](100-jsonata.md) expression, or array of link segments | Used to fetch additional information that will be displayed in a tooltip after clicking on the badge. To include links, provide an array of segments, each with a **text** field and an optional **href** field.                                                                                                                                                                                                                                                                                                                                                                                                                |
...
To include a link in the popover, use an array of segments with optional `href`:
