...
- `core-ui/public/extensions/extensions.yaml` is a plain YAML file, which you can use during the local development. This file is a list of all extracted configurations, without the ConfigMap header.
