...
| **simpleEmptyListMessage** | No       | boolean                        | An optional flag. If set to `true`, the empty Resource List will show: 'No entries found' message without any images or links.                                                                                                                 |
