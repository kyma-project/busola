...
| **customContent** | No       |      | Allows adding custom content to specific condition types. Each object should contain: <br> - `type` (required): The condition type to match <br> - `value` (required): A string, JSONata expression or a widget definition to render custom content <br> - `header`: Optional header text for the custom content section <br><br> The custom content will be rendered above the condition's default message.                                                                                                                                                                                                                                                                                                          |
