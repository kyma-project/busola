...
| **simpleEmptyListMessage** | No       | boolean                            | An optional flag. If set to `true`, the empty events list will show no resources message without any images or links.                                                                                                                                        |
...
| **simpleEmptyListMessage** | No       | boolean                                    | An optional flag. If set to `true`, the empty resource list will show no resources message without any images or links.                                                                                                                                                  |
