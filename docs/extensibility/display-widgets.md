...
- **disablePadding** - an optional boolean which disables the padding inside the panel body.
- **showSearchField** - an optional boolean which disables displaying search in Table.
- **showHeader** - an optional boolean which disables displaying head row in Table.
