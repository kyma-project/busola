...
| **description**                    | No       | string                                       | It displays a custom description on the resource list page. If the **translations** section has a translation entry with the ID that is the same as the **description** string, the translation is used.         |                    |     |        |                                                                                                                    |     |
