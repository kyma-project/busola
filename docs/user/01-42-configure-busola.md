...
Alternatively, select your namespace, and check if your extensions are loaded properly. For example, **Kustomized Horizontal Pod Autoscalers** in the **Discovery and Network** section, as provided in `resources/customization/extensions/extensions.yaml`.
