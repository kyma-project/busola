...
describe('EventActivationsService', () => {
  ...
  it('should be created', inject([EventActivationsService], (service: EventActivationsService) => {
  ...
  it('should get eventActivations', (done) => {
    ...
    eventActivationsService.getEventActivations(namespace, token).subscribe((res) => {
      done();
    });
  ...
  it('should handle empty eventActivations list', (done) => {
    ...
    const httpMock = httpClientMock.expectOne(
      `${AppConfig.graphqlApiUrl}`
    );
