      ...
      e.exports = (function() {
        ...
        (te.prototype.lookAhead = function(e) {
          ...
          (te.prototype.save = function(e) {
            var t =
              !1 !== e ? copyState(this.doc.mode, this.state) : this.state;
        ...
        function measureCharInner(e, t, n, r) {
          ...
          if (3 == l.nodeType) {
            ...
            a &&
              s < 11 &&
              (o = maybeUpdateRectForZooming(e.display.measure, o));
          } else {
            var h;
            c > 0 && (d = r = 'right'),
              (o =
        ...
        function endOperations(e) {
          for (var t, n = e.ops, r = 0; r < n.length; r++)
            endOperation_R1(n[r]);
        ...
        function updateDisplayIfNeeded(e, t) {
          ...
          n.viewFrom < i &&
            ...
            F &&
              ((i = visualLineNo(e.doc, i)), (a = visualLineEndNo(e.doc, a)));
          var s =
            i != n.viewFrom ||
            a != n.viewTo ||
        ...
        (ke.prototype = createObj(BranchChunk.prototype, {
          ...
          getLineHandleVisualStart: function(e) {
            return (
              'number' == typeof e && (e = getLine(this, e)), visualLine(e)
            );
          },
          lineCount: function() {
            return this.size;
          ...
          addSelection: docMethodOp(function(e, t, n) {
            ...
            r.push(new ye(clipPos(this, e), clipPos(this, t || e))),
              setSelection(
                this,
                normalizeSelection(this.cm, r, r.length - 1),
                n,
              );
          }),
        ...
        function applyTextInput(e, t, n, r, o) {
          ...
          if (a && r.ranges.length > 1)
            if (Ue && Ue.text.join('\n') == t) {
              if (r.ranges.length % Ue.text.length == 0) {
                l = [];
                for (var c = 0; c < Ue.text.length; c++)
                  l.push(i.splitLines(Ue.text[c]));
              }
            } else
          ...
          for (
            var u = e.curOp.updateInput, d = r.ranges.length - 1;
            d >= 0;
            d--
          ) {
            var p = r.ranges[d],
          ...
          t && !a && triggerElectric(e, t),
            ensureCursorVisible(e),
            e.curOp.updateInput < 2 && (e.curOp.updateInput = u),
            (e.curOp.typing = !0),
