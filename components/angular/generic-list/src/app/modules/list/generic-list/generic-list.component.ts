import { ChangeDetectorRef, Component, Input, OnChanges, OnInit, SimpleChanges, Type, ViewRef } from '@angular/core';
...
export class GenericListComponent implements OnChanges, OnInit {
    ...
    onFilterChanged(filterState) {
        ...
        this.searchSubscription = Observable.of(0).delay(250).subscribe(() => {
            ...
            .subscribe(
                result => {
                    if (retries > 0
                        && this.pagingState.pageNumber > 1
                        && result.totalCount > 0
                        && (this.pagingState.pageNumber - 1) * this.pagingState.pageSize >= result.totalCount) {
                        this.pagingState = {
                            pageNumber: Math.max(1, Math.ceil(result.totalCount / this.pagingState.pageSize)),
                    ...
                    this.showEmptyPage = (0 === result.data.length) && !this.filteringActive(this.filterState);
