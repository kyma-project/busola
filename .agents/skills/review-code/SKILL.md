...
Review current branch changes against the requirements and acceptance criteria of the GitHub issue passed as an argument. Evaluates whether the implementation fulfils the _intent_ of the issue — not just whether the code is technically correct.

## Input

Accepts a GitHub issue number as an argument (e.g. `/review-code 1234`).
